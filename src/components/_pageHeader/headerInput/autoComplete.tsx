...
const LoadingMessage = () => {
    return <p className="mb-1.5 px-2 py-2 text-slate-400"> Загружаю ... </p>;
};
...
const NothingFoundMessage: React.FC<{ query: string }> = ({ query }) => {
    return (
        ...
        ">
            <svg
                className="w-16 h-16 lg:w-24 lg:h-24 -mt-4 text-gray-600"
            ...
            <p className="my-1.5 px-2 text-base lg:text-xl text-slate-300">
